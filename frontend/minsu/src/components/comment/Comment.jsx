...
function Comment(props) {
	...
	const { postId } = useParams(); // boardId, 파라미터 가져오기
	...
	const updateComment = async () => {
		...
		await axios.patch(`${import.meta.env.VITE_REST_API}/post/${postId}/comment/update/${commentId}`, request, {headers: headers})
		.then((response) => {
	...
	const deleteComment = async () => {
		await axios.delete(`${import.meta.env.VITE_REST_API}/post/${postId}}/comment/delete/${commentId}`, {headers: headers})
			.then((response) => {
			...
			<>
				...
				<div className="my-1 d-flex justify-content-center">
					...
					<div className="col-4 d-flex justify-content-end">
					{
						...
						(sessionStorage.getItem("id") == comment.commentWriterName) ?
							<>
